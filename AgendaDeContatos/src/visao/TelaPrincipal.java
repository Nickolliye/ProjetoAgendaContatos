    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(108, 108, 108)
                .addComponent(jButton1_Adicionar, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jButton3_Excluir, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jButton2_Alterar, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(148, 148, 148)
                .addComponent(jButton4_Listar, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jButton1_PDF, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGap(143, 143, 143))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(66, 66, 66)
...
private void GerarPDF() throws Exception {
    ...
    private void jButton2_AlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2_AlterarActionPerformed
        ...
        try{
            if (selecionado != -1) {
            // Captura os dados do contato da linha selecionada
            String nome = jTable1_Tabela.getValueAt(selecionado, 0).toString();
            String telefoneStr = jTable1_Tabela.getValueAt(selecionado, 1).toString();
            String email = jTable1_Tabela.getValueAt(selecionado, 2).toString();
            String enderecoStr = jTable1_Tabela.getValueAt(selecionado, 3).toString();

            // Parseia o telefone
            String[] partesTelefone = telefoneStr.split(";");
            int ddi = Integer.parseInt(partesTelefone[0]);
            int ddd = Integer.parseInt(partesTelefone[1]);
            int numero = Integer.parseInt(partesTelefone[2]);
            Telefone telefone = new Telefone(ddi, ddd, numero);

            // Parseia o endereço
            String[] partesEndereco = enderecoStr.split(";");
            String logradouro = partesEndereco[0];
            int numeroEndereco = Integer.parseInt(partesEndereco[1]);
            String complemento = partesEndereco[2];
            int cep = Integer.parseInt(partesEndereco[3]);
            String cidade = partesEndereco[4];
            String estado = partesEndereco[5];
            Endereco endereco = new Endereco(logradouro, numeroEndereco, complemento, cep, cidade, estado);

            
            // Crie um objeto Contato com esses dados
            Contato contatoSelecionado = new Contato(nome, telefone, email, endereco);

            // Chame o método alterar
            ContatoDAO cont = new ContatoDAO();
            cont.alterar(contatoSelecionado);
        } else {
